var Palabrasverificadas = document.getElementById("Palabras verificadas");
var TipoCadena = document.getElementById("TipoCadena");

function funcion(){
    alert("Reconocedor: " + texto.value );
...
for(var i=0; i<=texto.value.length; i++){
    ...
    if(reconocedorError==1  || reconocedorError2==1 )  {
        ...
        alert("Error");
        cadena="Error";
        document.getElementById("TipoCadena").style.color = "red";

        document.getElementById('tex1').style.color = 'red';

    }

    TipoCadena.innerHTML = TipoCadena.innerHTML + cadena + "<br>";
    Palabrasverificadas.innerHTML = Palabrasverificadas.innerHTML + texto.value + "<br>";
...
function color() {
    ...
    document.getElementById("Palabras verificadas").style.color = "red";
